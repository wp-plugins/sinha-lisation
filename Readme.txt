=== Plugin Name ===
Contributors: darshanasbg
Donate link: http://darray.wordpress.com/2011/04/08/project-sinha-lisation/
Tags: language, comments, Sinhala
Requires at least: 2.0.2
Tested up to: 2.1
Stable tag: 1.0.1

Simply this enables Singlish-to-Sinhala ability for any user who working in Sinhala language, without any more requirements…
...
= How do enable the Singlish-to-Sinhala conversion =

Select the place you want to type in Sinhala, and press Scroll lock.

= How do disable the Singlish-to-Sinhala conversion =

Press Scroll lock again... It will disable the Singlish-to-Sinhala conversion.
